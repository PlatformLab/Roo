...
/**
 * @file
 * This file is used to control how Roo's debug log (event log) messages are
 * handled.
 */

#ifndef ROO_INCLUDE_ROO_DEBUG_H
#define ROO_INCLUDE_ROO_DEBUG_H
...
/**
 * When Roo wants to print a log message, this is the included information.
 */
struct DebugMessage {
    /// Default constructor.
    DebugMessage();
