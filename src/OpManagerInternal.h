...
#ifndef ROO_OPMANAGERINTERNAL_H
#define ROO_OPMANAGERINTERNAL_H
...
struct OpManagerInternal {
    ...
    std::unordered_map<Proto::OpId, RemoteOp*, Proto::OpId::Hasher> remoteOps;
