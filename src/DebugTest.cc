/* Copyright (c) 2012-2020, Stanford University
...
TEST_F(DebugTest, isLogging)
{
    ...
    EXPECT_EQ(1U, Internal::isLoggingCache.size());
    EXPECT_STREQ("abc", Internal::isLoggingCache.begin()->first);
    EXPECT_EQ(LogLevel::NOTICE, Internal::isLoggingCache.begin()->second);
}
